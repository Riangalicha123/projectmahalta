                  ...
                  <tr>
                    ...
                    <td class="project-state">
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="<?= base_url("/staff/updateconStatus/Confirm/{$reevent['ReservationID']}") ?>">Confirm</a>
                            <a class="dropdown-item" href="<?= base_url("/staff/updateconStatus/Pending/{$reevent['ReservationID']}") ?>">Pending</a>
                            <a class="dropdown-item" href="<?= base_url("/staff/updateconStatus/Cancel/{$reevent['ReservationID']}") ?>">Cancel</a>
                            </div>
                        </div>
                    </td>
