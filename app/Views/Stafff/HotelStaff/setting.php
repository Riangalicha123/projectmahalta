            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <?php endif ?>
                    <form class="form-horizontal" action="<?= base_url('updatehotelProfile/' . $_SESSION['id']) ?>" method="post">
                  ...
                  <?php endif; ?>
                    <form class="form-horizontal" action="<?= base_url('/staff/hotel/update-password') ?>" method="post">
                      <div class="form-group row">
