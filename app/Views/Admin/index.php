              ...
              <div class="row">
                <div class="col-lg-4 col-6">
                  <div class="small-box bg-success">
                    <div class="inner">
                      <h3><?= number_format($averagePositiveConfidence, 2) ?>%</h3>
                      <p>Positive Confidence</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-6">
                  <div class="small-box bg-warning">
                    <div class="inner">
                      <h3><?= number_format($averageNeutralConfidence, 2) ?>%</h3>
                      <p>Neutral Confidence</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-6">
                  <div class="small-box bg-danger">
                    <div class="inner">
                      <h3><?= number_format($averageNegativeConfidence, 2) ?>%</h3>
                      <p>Negative Confidence</p>
                    </div>
                  </div>
                </div>
              </div>
