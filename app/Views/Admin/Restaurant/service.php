    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card-body pb-0">
          ...
          <hr>
          <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#aaaddoonnnnModal">
            Add Meal Deals
          </button>
          <div class="row">
            <?php foreach ($mealdeals as $mealdeal): ?>
            <div class="col-12 col-sm-6 col-md-3 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                <div class="card-header text-muted border-bottom-0">
                Meal Deals
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b><?=$mealdeal['MealdealsName']?></b></h2>
                      <p class="text-muted text-sm"><b>Php: </b> <?=$mealdeal['MealdealsPrice']?></p>
                    </div>
                    <div class="col-5 text-center">
                      <img src="<?=base_url('/restaurant/'.$mealdeal['Image'])?>" alt="user-avatar" class="img-circle img-fluid" style="width:100px;height:100px;">
                    </div>
                  </div>
                </div>
                <div class="card-footer">
                <div class="text-right">
                  ...
                  <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#rrefoorrrmmmModal<?=$mealdeal['MealdealsID']?>">
                    Update
                  </button>
                </div>
                <!-- Add Modal -->
                <div class="modal fade" id="aaaddoonnnnModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="addModalLabel">Add Data</h5>
                      ...
                      <div class="modal-body">
                        <!-- Add your form inputs here -->
                        <form action="<?= base_url('addMealdeals/') ?>" method="post" enctype="multipart/form-data" id="addForm">
                        <div class="card-body">
                        
                          <div class="form-group">
                            <label for="MealdealsName">Name</label>
                            <input type="text" class="form-control" id="MealdealsName" name="MealdealsName" placeholder="Enter Name" >
                          </div>
                          <div class="form-group">
                            <label for="MealdealsPrice">Price</label>
                            <input type="number" class="form-control" id="MealdealsPrice" name="MealdealsPrice" placeholder="Enter Price" >
                          </div>
                          <div class="form-group">
                            <label for="Image">Upload</label>
                            <input type="file" class="form-control" id="Image" id="inputImage" name="Image" accept="Image/*" >
                ...
                <div class="modal fade" id="rrefoorrrmmmModal<?=$mealdeal['MealdealsID']?>" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel<?=$mealdeal['MealdealsID']?>" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="updateModalLabel<?=$mealdeal['MealdealsID']?>">Update Data</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <div class="modal-body">
                        <!-- Add your form inputs here -->
                        <form action="<?= base_url('/updateMealdeals/') ?>" method="post" enctype="multipart/form-data" id="updateForm">
                          <div class="card-body">
                        <input type="hidden" name="MealdealsID" id="MealdealsID" value="<?=$mealdeal['MealdealsID']?>">
                          <div class="form-group">
                            <label for="MealdealsName">Name</label>
                            <input type="text" class="form-control" id="MealdealsName" name="MealdealsName" placeholder="Enter Input" value="<?=$mealdeal['MealdealsName']?>">
                          </div>
                          <div class="form-group">
                            <label for="MealdealsPrice">Price</label>
                            <input type="number" class="form-control" id="MealdealsPrice" name="MealdealsPrice" placeholder="Enter Input" value="<?=$mealdeal['MealdealsPrice']?>">
                          </div>
                          <div class="form-group">
                            <label for="Image">Upload</label>
                            <input type="file" class="form-control" id="Image" id="inputImage" name="Image" accept="Image/*" value="<?=$mealdeal['Image']?>">
                            </div>
                          </div>
