...
<head>
  <title>Mahalta Resort and Convention Center</title>
  <!-- Site favicon -->
  <link
...
<body>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(document).on('mouseleave', '.submit_star', function() {
        reset_background();
        for (var count = 1; count <= UserRating; count++) {
  ...
  <script type="module">
    ...
    const firebaseConfig = {
      apiKey: "AIzaSyAGUoOEqES96jsoK-pjxhF8MlWM2QaKHiw",
      authDomain: "push-notif-309d3.firebaseapp.com",
      projectId: "push-notif-309d3",
      storageBucket: "push-notif-309d3.firebasestorage.app",
      messagingSenderId: "690832026280",
      appId: "1:690832026280:web:58d039ec6ecd7b00df709d",
      measurementId: "G-TL2Y197L0J"
    };
    ...
    navigator.serviceWorker.register("sw.js").then(registration => {
      getToken(messaging, {
        ...
        vapidKey: 'BCv18VhMLrCUbH3WxGRx5lPDNGdKPLV41nf8kyeXDoD8hqgPAeyNiDcfD18rLyCDeIkpW-lzGyq0-7xxe_VMAwY'
      }).then((currentToken) => {
        if (currentToken) {
          ...
          fetch('/saveToken', {
            ...
            .then(response => {
              if (!response.ok) {
                ...
                return response.text(); // Convert to text to see HTML error page if any
              }
