...
<section  class="site-section" style="background: #FAF2D3; padding: 20px;">
    <div class="menu-title">
      <h1>Bar Menu</h1>
    </div>
        <div class="category-buttons" style="margin-top: 20px; display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;">
          <button onclick="showCategory('12')" style="padding: 10px 20px; flex: 1 1 100px; max-width: 150px; min-width: 100px; background: linear-gradient(to bottom, rgba(245, 245, 245, 0.9), rgba(230, 230, 230, 0.7)); color: #333; font-weight: bold; border: none; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); transition: background 0.3s, transform 0.2s; text-align: center;">Cocktails</button>
          <button onclick="showCategory('13')" style="padding: 10px 20px; flex: 1 1 100px; max-width: 150px; min-width: 100px; background: linear-gradient(to bottom, rgba(245, 245, 245, 0.9), rgba(230, 230, 230, 0.7)); color: #333; font-weight: bold; border: none; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); transition: background 0.3s, transform 0.2s; text-align: center;">Mocktails</button>
          <button onclick="showCategory('14')" style="padding: 10px 20px; flex: 1 1 100px; max-width: 150px; min-width: 100px; background: linear-gradient(to bottom, rgba(245, 245, 245, 0.9), rgba(230, 230, 230, 0.7)); color: #333; font-weight: bold; border: none; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); transition: background 0.3s, transform 0.2s; text-align: center;">Shooter</button>
          <button onclick="showCategory('15')" style="padding: 10px 20px; flex: 1 1 100px; max-width: 150px; min-width: 100px; background: linear-gradient(to bottom, rgba(245, 245, 245, 0.9), rgba(230, 230, 230, 0.7)); color: #333; font-weight: bold; border: none; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); transition: background 0.3s, transform 0.2s; text-align: center;">Tower(3L)</button>
          <button onclick="showCategory('16')" style="padding: 10px 20px; flex: 1 1 100px; max-width: 150px; min-width: 100px; background: linear-gradient(to bottom, rgba(245, 245, 245, 0.9), rgba(230, 230, 230, 0.7)); color: #333; font-weight: bold; border: none; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); transition: background 0.3s, transform 0.2s; text-align: center;">Juices</button>
          <button onclick="showCategory('17')" style="padding: 10px 20px; flex: 1 1 100px; max-width: 150px; min-width: 100px; background: linear-gradient(to bottom, rgba(245, 245, 245, 0.9), rgba(230, 230, 230, 0.7)); color: #333; font-weight: bold; border: none; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); transition: background 0.3s, transform 0.2s; text-align: center;">Shakes</button>
          <button onclick="showCategory('18')" style="padding: 10px 20px; flex: 1 1 100px; max-width: 150px; min-width: 100px; background: linear-gradient(to bottom, rgba(245, 245, 245, 0.9), rgba(230, 230, 230, 0.7)); color: #333; font-weight: bold; border: none; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); transition: background 0.3s, transform 0.2s; text-align: center;">Liquors</button>
          <button onclick="showCategory('19')" style="padding: 10px 20px; flex: 1 1 100px; max-width: 150px; min-width: 100px; background: linear-gradient(to bottom, rgba(245, 245, 245, 0.9), rgba(230, 230, 230, 0.7)); color: #333; font-weight: bold; border: none; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); transition: background 0.3s, transform 0.2s; text-align: center;">Red Wines</button>
          <button onclick="showCategory('20')" style="padding: 10px 20px; flex: 1 1 100px; max-width: 150px; min-width: 100px; background: linear-gradient(to bottom, rgba(245, 245, 245, 0.9), rgba(230, 230, 230, 0.7)); color: #333; font-weight: bold; border: none; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); transition: background 0.3s, transform 0.2s; text-align: center;">Bear</button>
          <button onclick="showCategory('21')" style="padding: 10px 20px; flex: 1 1 100px; max-width: 150px; min-width: 100px; background: linear-gradient(to bottom, rgba(245, 245, 245, 0.9), rgba(230, 230, 230, 0.7)); color: #333; font-weight: bold; border: none; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); transition: background 0.3s, transform 0.2s; text-align: center;">Beers</button>
        </div>
