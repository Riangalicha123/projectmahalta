            ...
            <div class="col-sm-12">
                <div class="media d-block room mb-0">
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                                <label for="roomsguestsPopover">Select rooms and guests</label>
                                <button type="button" class="form-control" id="roomsguestsPopover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom">
                                    View
                                </button>
...
$(document).ready(function () {
  initializePage();
    ...
    <script>
        ...
        const config = {
            mode: "range",
            dateFormat: "F j/Y - F j/Y (d\\ nights)", 
            showMonths: 2,
            minDate: currentDate,
            onChange: function(selectedDates, dateStr, instance) {
                ...
                const formattedDateRange = `${formattedCheckIn} - ${formattedCheckOut} (${nights} nights)`;
